...
#if CHECKFREEDISK
	using Server.Commands;        // needed for BroadCastMessage
...
namespace Server.Misc
{
    ...
    // --- SETTINGS ---
        ...
        private static TimeSpan m_Delay = Config.Get("AutoSave.Frequency", TimeSpan.FromMinutes( 60.0 ));

        
    // Use one of the following m_Warning settings:
        
        //   Sets the warning before a save to 60 seconds.
        private static TimeSpan m_Warning = Config.Get("AutoSave.WarningTime", TimeSpan.FromSeconds( 10.0 ));
...
*/
        ...
        public static void Save()
        {
            ...
            ulong savesize = directorySize( Path.Combine( Core.BaseDirectory, "Saves" ) );
            ...
            worked = GetDiskFreeSpaceEx( rootdrive,
        ...
        // m_Archive may point to a different drive than the one RunUO is on...
            ...
            if ( m_Archive != null )
            {
                ...
                {
                    worked = GetDiskFreeSpaceEx( arootdrive,
                        out freeBytesAvailable,
                        out totalNumberOfBytes,
                        out totalNumberOfFreeBytes);
...
*/
    ...
    */
        ...
        public static ulong directorySize( string dir )
        {
            ulong size = 0;
