...
{
	public class SeedChestGump : Gump
	{
		private Mobile m_Owner;
		private SeedChest m_box;
		private int m_id;
		...
		public SeedChestGump( Mobile owner, SeedChest box ) : this( owner, box, 0 )
		{}

		public SeedChestGump( Mobile owner , SeedChest box, int PlantId ) : base( 10, 10 )
		{
			owner.CloseGump( typeof( SeedChestGump ) );
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			{
				from.SendGump( new SeedChestGump( from, m_box, info.ButtonID - 1 ) );
				return ;
			}
			...
			if ( info.ButtonID >= 18 )
			{
				...
				if ( bid != -1 )
				{
					...
					from.SendGump( new SeedChestGump( from, m_box, m_id ) );
				}
			}
		}
