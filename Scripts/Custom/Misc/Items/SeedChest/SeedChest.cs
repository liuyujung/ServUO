...
namespace Server.Items
{
    ...
    public class SeedChest : BaseContainer
    {
...
//			return;
            ...
            if ( !from.InRange( GetWorldLocation(), 2 ) )
                ...
                from.SendGump( new SeedChestGump( ( PlayerMobile ) from, this ) );
        }

        public SeedChest( Serial serial ) : base( serial )
		{
		}
