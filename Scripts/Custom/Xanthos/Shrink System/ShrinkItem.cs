...
{
	public class ShrinkItemX : Item, IShrinkItem
	{
		// Persisted
		...
		public ShrinkItemX() : base()
		{
		}

		public ShrinkItemX( Serial serial ) : base( serial )
		{
		}

		public ShrinkItemX( BaseCreature pet ) : this()
		{
			ShrinkPet( pet );
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( m_Locked && m_Owner != from )
			{
				...
				from.SendMessage( 54, "The server is on a ShrinkItemX lockdown. You cannot unshrink your pet at this time." );
		...
		public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list )
		{
			...
			{
				if ( m_Locked == false )
					list.Add( new LockShrinkItemX( from, this ) );
				else
					list.Add( new UnLockShrinkItemX( from, this ) );
			}
		}
	...
	public class LockShrinkItemX : ContextMenuEntry
	{
		private Mobile m_From;
		private ShrinkItemX m_ShrinkItemX;

		public LockShrinkItemX( Mobile from, ShrinkItemX shrink ) : base( 2029, 5 )
		{
			m_From = from;
			m_ShrinkItemX = shrink;
		}

		public override void OnClick()
		{
			m_ShrinkItemX.Locked = true;
			m_From.SendMessage( 38, "You have locked this shrunken pet so only you can reclaim it." );
		}
	}

	public class UnLockShrinkItemX : ContextMenuEntry
	{
		private Mobile m_From;
		private ShrinkItemX m_ShrinkItemX;

		public UnLockShrinkItemX( Mobile from, ShrinkItemX shrink ) : base( 2033, 5 )
		{
			m_From = from;
			m_ShrinkItemX = shrink;
		}
