...
namespace Xanthos.Evo
{
	...
	public class EvoPolarBear : BaseEvoMount, IEvoCreature
	{
		public override BaseEvoSpec GetEvoSpec()
		{
			return PolarBearEvoSpec.Instance;
		}

		public override BaseEvoEgg GetEvoEgg()
		{
			return new PolarBearEvoEgg();
		}

		public override bool AddPointsOnDamage { get { return true; } }
		public override bool AddPointsOnMelee { get { return false; } }
		public override Type GetEvoDustType() { return typeof( PolarBearEvoDust ); }

		public override bool HasBreath{ get{ return false; } }

		public EvoPolarBear( string name ) : base( name, 0xD5, 0x3EC5 )
		{
		}

		public EvoPolarBear( Serial serial ) : base( serial )
		{
		}
