...
{
	public sealed class PolarBearEvoSpec : BaseEvoSpec
	{
		...
		PolarBearEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new PolarBearStageOne(), new PolarBearStageTwo(), new PolarBearStageThree(),
											  new PolarBearStageFour(), new PolarBearStageFive() };
		}
		...
		public static PolarBearEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly PolarBearEvoSpec instance = new PolarBearEvoSpec();}
	}	
	...
	public class PolarBearStageOne : BaseEvoStage
	{
		public PolarBearStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0xA3;
			BodyValue = 213; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class PolarBearStageTwo : BaseEvoStage
	{
		public PolarBearStageTwo()
		{
			EvolutionMessage = "has evolved";
	...
	public class PolarBearStageThree : BaseEvoStage
	{
		public PolarBearStageThree()
		{
			EvolutionMessage = "has evolved";
	...
	public class PolarBearStageFour : BaseEvoStage
	{
		public PolarBearStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA3;
			BodyValue = 213; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class PolarBearStageFive : BaseEvoStage
	{
		public PolarBearStageFive()
		{
			Title = "The Ancient Polar Bear";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Polar Bear";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA3; ControlSlots = 4;
			BodyValue = 213; VirtualArmor = 100;
