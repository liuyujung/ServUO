...
{
	public sealed class LlamaEvoSpec : BaseEvoSpec
	{
		...
		LlamaEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new LlamaStageOne(), new LlamaStageTwo(), new LlamaStageThree(),
											  new LlamaStageFour(), new LlamaStageFive() };
		}
		...
		public static LlamaEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly LlamaEvoSpec instance = new LlamaEvoSpec();}
	}	
	...
	public class LlamaStageOne : BaseEvoStage
	{
		public LlamaStageOne()
		{
	...
	public class LlamaStageTwo : BaseEvoStage
	{
		public LlamaStageTwo()
		{
			EvolutionMessage = "has evolved";
	...
	public class LlamaStageThree : BaseEvoStage
	{
		public LlamaStageThree()
		{
			EvolutionMessage = "has evolved";
	...
	public class LlamaStageFour : BaseEvoStage
	{
		public LlamaStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 220; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class LlamaStageFive : BaseEvoStage
	{
		public LlamaStageFive()
		{
			Title = "The Ancient Llama";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Llama";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x3F3; ControlSlots = 4;
			BodyValue = 220; VirtualArmor = 100;
