...
{
	public sealed class SteedEvoSpec : BaseEvoSpec
	{
		...
		SteedEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new SteedStageOne(), new SteedStageTwo(), new SteedStageThree(),
											  new SteedStageFour(), new SteedStageFive() };
		}
		...
		public static SteedEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly SteedEvoSpec instance = new SteedEvoSpec();}
	}	
	...
	public class SteedStageOne : BaseEvoStage
	{
		public SteedStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 200; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class SteedStageTwo : BaseEvoStage
	{
		public SteedStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 200; VirtualArmor = 40;
	...
	public class SteedStageThree : BaseEvoStage
	{
		public SteedStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 200; VirtualArmor = 50;
	...
	public class SteedStageFour : BaseEvoStage
	{
		public SteedStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 200; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class SteedStageFive : BaseEvoStage
	{
		public SteedStageFive()
		{
			Title = "The Ancient Steed";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Steed";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA8; ControlSlots = 4;
			BodyValue = 200; VirtualArmor = 100;
