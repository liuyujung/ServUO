...
{
	public sealed class SavageRidgebackEvoSpec : BaseEvoSpec
	{
		...
		SavageRidgebackEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new SavageRidgebackStageOne(), new SavageRidgebackStageTwo(), new SavageRidgebackStageThree(),
											  new SavageRidgebackStageFour(), new SavageRidgebackStageFive() };
		}
		...
		public static SavageRidgebackEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly SavageRidgebackEvoSpec instance = new SavageRidgebackEvoSpec();}
	}	
	...
	public class SavageRidgebackStageOne : BaseEvoStage
	{
		public SavageRidgebackStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 188; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class SavageRidgebackStageTwo : BaseEvoStage
	{
		public SavageRidgebackStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 188; VirtualArmor = 40;
	...
	public class SavageRidgebackStageThree : BaseEvoStage
	{
		public SavageRidgebackStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 188; VirtualArmor = 50;
	...
	public class SavageRidgebackStageFour : BaseEvoStage
	{
		public SavageRidgebackStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 188; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class SavageRidgebackStageFive : BaseEvoStage
	{
		public SavageRidgebackStageFive()
		{
			Title = "The Ancient Savage Ridgeback";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Savage Ridgeback";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x3F3; ControlSlots = 4;
			BodyValue = 188; VirtualArmor = 100;
