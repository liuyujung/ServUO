...
namespace Xanthos.Evo
{
	...
	public class UnicornStageOne : BaseEvoStage
	{
		public UnicornStageOne()
		{
			...
			BaseSoundID = 0x4BC;
			BodyValue = 122; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class UnicornStageFour : BaseEvoStage
	{
		public UnicornStageFour()
		{
			...
			BaseSoundID = 0x4BC;
			BodyValue = 122; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class UnicornStageFive : BaseEvoStage
	{
		public UnicornStageFive()
		{
			...
			BaseSoundID = 0x4BC; ControlSlots = 4;
			BodyValue = 122; VirtualArmor = 100;
