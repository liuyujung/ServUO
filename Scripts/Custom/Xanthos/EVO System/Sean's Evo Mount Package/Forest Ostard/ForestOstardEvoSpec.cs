...
{
	public sealed class ForestOstardEvoSpec : BaseEvoSpec
	{
		...
		ForestOstardEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new ForestOstardStageOne(), new ForestOstardStageTwo(), new ForestOstardStageThree(),
											  new ForestOstardStageFour(), new ForestOstardStageFive() };
		}
		...
		public static ForestOstardEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly ForestOstardEvoSpec instance = new ForestOstardEvoSpec();}
	}	
	...
	public class ForestOstardStageOne : BaseEvoStage
	{
		public ForestOstardStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 219; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class ForestOstardStageTwo : BaseEvoStage
	{
		public ForestOstardStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 219; VirtualArmor = 40;
	...
	public class ForestOstardStageThree : BaseEvoStage
	{
		public ForestOstardStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 219; VirtualArmor = 50;
	...
	public class ForestOstardStageFour : BaseEvoStage
	{
		public ForestOstardStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 219; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class ForestOstardStageFive : BaseEvoStage
	{
		public ForestOstardStageFive()
		{
			Title = "The Ancient Forest Ostard";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Forest Ostard";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x270; ControlSlots = 4;
			BodyValue = 219; VirtualArmor = 100;
