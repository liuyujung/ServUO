...
{
	public sealed class ChargerOfTheFallenEvoSpec : BaseEvoSpec
	{
		...
		ChargerOfTheFallenEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new ChargerOfTheFallenStageOne(), new ChargerOfTheFallenStageTwo(), new ChargerOfTheFallenStageThree(),
											  new ChargerOfTheFallenStageFour(), new ChargerOfTheFallenStageFive() };
		}
		...
		public static ChargerOfTheFallenEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly ChargerOfTheFallenEvoSpec instance = new ChargerOfTheFallenEvoSpec();}
	}	
	...
	public class ChargerOfTheFallenStageOne : BaseEvoStage
	{
		public ChargerOfTheFallenStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 284; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class ChargerOfTheFallenStageTwo : BaseEvoStage
	{
		public ChargerOfTheFallenStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 284; VirtualArmor = 40;
	...
	public class ChargerOfTheFallenStageThree : BaseEvoStage
	{
		public ChargerOfTheFallenStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 284; VirtualArmor = 50;
	...
	public class ChargerOfTheFallenStageFour : BaseEvoStage
	{
		public ChargerOfTheFallenStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA8;
			BodyValue = 284; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class ChargerOfTheFallenStageFive : BaseEvoStage
	{
		public ChargerOfTheFallenStageFive()
		{
			Title = "The Ancient Charger Of The Fallen";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Charger Of The Fallen";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA8; ControlSlots = 4;
			BodyValue = 284; VirtualArmor = 100;
