...
{
	public sealed class RidgebackEvoSpec : BaseEvoSpec
	{
		...
		RidgebackEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new RidgebackStageOne(), new RidgebackStageTwo(), new RidgebackStageThree(),
											  new RidgebackStageFour(), new RidgebackStageFive() };
		}
		...
		public static RidgebackEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly RidgebackEvoSpec instance = new RidgebackEvoSpec();}
	}	
	...
	public class RidgebackStageOne : BaseEvoStage
	{
		public RidgebackStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 187; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class RidgebackStageTwo : BaseEvoStage
	{
		public RidgebackStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 187; VirtualArmor = 40;
	...
	public class RidgebackStageThree : BaseEvoStage
	{
		public RidgebackStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 187; VirtualArmor = 50;
	...
	public class RidgebackStageFour : BaseEvoStage
	{
		public RidgebackStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x3F3;
			BodyValue = 187; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class RidgebackStageFive : BaseEvoStage
	{
		public RidgebackStageFive()
		{
			Title = "The Ancient Ridgeback";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Ridgeback";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x3F3; ControlSlots = 4;
			BodyValue = 187; VirtualArmor = 100;
