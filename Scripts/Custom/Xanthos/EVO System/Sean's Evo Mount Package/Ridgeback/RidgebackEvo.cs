...
namespace Xanthos.Evo
{
	...
	public class EvoRidgeback : BaseEvoMount, IEvoCreature
	{
		public override BaseEvoSpec GetEvoSpec()
		{
			return RidgebackEvoSpec.Instance;
		}

		public override BaseEvoEgg GetEvoEgg()
		{
			return new RidgebackEvoEgg();
		}

		public override bool AddPointsOnDamage { get { return true; } }
		public override bool AddPointsOnMelee { get { return false; } }
		public override Type GetEvoDustType() { return typeof( RidgebackEvoDust ); }

		public override bool HasBreath{ get{ return false; } }

		public EvoRidgeback( string name ) : base( name, 0xBB, 0x3EBA )
		{
		}

		public EvoRidgeback( Serial serial ) : base( serial )
		{
		}
