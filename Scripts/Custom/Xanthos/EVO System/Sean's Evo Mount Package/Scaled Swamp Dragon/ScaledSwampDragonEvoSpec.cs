...
{
	public sealed class ScaledSwampDragonEvoSpec : BaseEvoSpec
	{
		...
		ScaledSwampDragonEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new ScaledSwampDragonStageOne(), new ScaledSwampDragonStageTwo(), new ScaledSwampDragonStageThree(),
											  new ScaledSwampDragonStageFour(), new ScaledSwampDragonStageFive() };
		}
		...
		public static ScaledSwampDragonEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly ScaledSwampDragonEvoSpec instance = new ScaledSwampDragonEvoSpec();}
	}	
	...
	public class ScaledSwampDragonStageOne : BaseEvoStage
	{
		public ScaledSwampDragonStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0x16A;
			BodyValue = 799; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class ScaledSwampDragonStageTwo : BaseEvoStage
	{
		public ScaledSwampDragonStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0x16A;
			BodyValue = 799; VirtualArmor = 40;
	...
	public class ScaledSwampDragonStageThree : BaseEvoStage
	{
		public ScaledSwampDragonStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x16A;
			BodyValue = 799; VirtualArmor = 50;
	...
	public class ScaledSwampDragonStageFour : BaseEvoStage
	{
		public ScaledSwampDragonStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x16A;
			BodyValue = 799; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class ScaledSwampDragonStageFive : BaseEvoStage
	{
		public ScaledSwampDragonStageFive()
		{
			Title = "The Ancient Scaled Swamp Dragon";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Scaled Swamp Dragon";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x16A; ControlSlots = 4;
			BodyValue = 799; VirtualArmor = 100;
