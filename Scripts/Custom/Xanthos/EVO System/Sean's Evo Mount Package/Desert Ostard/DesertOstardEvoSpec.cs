...
{
	public sealed class DesertOstardEvoSpec : BaseEvoSpec
	{
		...
		DesertOstardEvoSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new DesertOstardStageOne(), new DesertOstardStageTwo(), new DesertOstardStageThree(),
											  new DesertOstardStageFour(), new DesertOstardStageFive() };
		}
		...
		public static DesertOstardEvoSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly DesertOstardEvoSpec instance = new DesertOstardEvoSpec();}
	}	
	...
	public class DesertOstardStageOne : BaseEvoStage
	{
		public DesertOstardStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 25000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 210; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class DesertOstardStageTwo : BaseEvoStage
	{
		public DesertOstardStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 210; VirtualArmor = 40;
	...
	public class DesertOstardStageThree : BaseEvoStage
	{
		public DesertOstardStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1250000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 210; VirtualArmor = 50;
	...
	public class DesertOstardStageFour : BaseEvoStage
	{
		public DesertOstardStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 7750000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x270;
			BodyValue = 210; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class DesertOstardStageFive : BaseEvoStage
	{
		public DesertOstardStageFive()
		{
			Title = "The Ancient Desert Ostard";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Desert Ostard";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0x270; ControlSlots = 4;
			BodyValue = 210; VirtualArmor = 100;
