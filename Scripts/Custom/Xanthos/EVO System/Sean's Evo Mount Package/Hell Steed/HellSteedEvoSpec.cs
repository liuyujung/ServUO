...
namespace Xanthos.Evo
{
	...
	public class HellSteedStageOne : BaseEvoStage
	{
		public HellSteedStageOne()
		{
			...
			BaseSoundID = 0xA8;
			BodyValue = 793; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class HellSteedStageFour : BaseEvoStage
	{
		public HellSteedStageFour()
		{
			...
			BaseSoundID = 0xA8;
			BodyValue = 793; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class HellSteedStageFive : BaseEvoStage
	{
		...
		{
			Title = "The Ancient Hell Steed";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Hell Steed";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0xA8; ControlSlots = 4;
			BodyValue = 793; VirtualArmor = 100;
