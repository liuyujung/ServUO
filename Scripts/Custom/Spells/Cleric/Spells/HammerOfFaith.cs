...
namespace Server.Spells.Cleric
{
	public class ClericHammerOfFaithSpell : ClericSpell
	{
		...
		private class ClericHammerOfFaith : BaseBashing
		{
			...
			[Constructable]
			public ClericHammerOfFaith( Mobile owner ) : base( 0x1439 )
			{
				m_Owner = owner;
				Weight = 10.0;
			...
			public ClericHammerOfFaith( Serial serial ) : base( serial )
			{
			}
		...
		{
			private ClericHammerOfFaith m_Hammer;
			private DateTime m_Expire;
			
			public InternalTimer( ClericHammerOfFaith hammer, DateTime expire ) : base( TimeSpan.Zero, TimeSpan.FromSeconds( 0.1 ) )
			{
				m_Hammer = hammer;
				m_Expire = expire;
			}
