...
{
	public class DruidSpellbookGump : BaseCGump
	{
		...
		public override string MLab{   get{ return "Druid Spells"; } }
		public override int Horz{   get{ return 100; } }
		public override int Vert{   get{ return 10; } }
		
		public DruidSpellbookGump( Mobile from, DruidSpellbook book ) : base( from, book )
		{
		}
