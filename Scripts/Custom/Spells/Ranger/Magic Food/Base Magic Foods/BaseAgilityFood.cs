...
{
	public abstract class BaseAgilityFood : BaseMagicFood
	{
		public abstract int DexOffset{ get; }
		public abstract TimeSpan Duration{ get; }

		public BaseAgilityFood( MagicFoodEffect effect ) : base( 0xD39, effect )
		{
		}

		public BaseAgilityFood( Serial serial ) : base( serial )
		{
		}
