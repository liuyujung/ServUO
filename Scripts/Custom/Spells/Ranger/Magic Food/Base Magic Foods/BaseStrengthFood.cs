...
{
	public abstract class BaseStrengthFood : BaseMagicFood
	{
		public abstract int StrOffset{ get; }
		public abstract TimeSpan Duration{ get; }

		public BaseStrengthFood( MagicFoodEffect effect ) : base( 0xF09, effect )
		{
		}

		public BaseStrengthFood( Serial serial ) : base( serial )
		{
		}
